...
class CONEXAOPUBLICO  {
	...
	var $base_publico;// = $this->ini['conexao']['banco_publico'];
	var $porta;// = $this->ini['conexao']['porta']; 	

function CONEXAOPUBLICO(){
  	
	$this->Conecta();
}
function Conecta(){
	//$criptografa = new funcoes();
	$this->ini = parse_ini_file('conexao_envia.ini', true);
	...
	$this->link = mysqli_connect($this->url.':'.$this->porta,$this->login,$this->senha, $this->base_publico);
