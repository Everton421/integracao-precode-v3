...
class CONEXAOVENDAS  {
	...
	var $base_vendas;// = $this->ini['conexao']['banco_publico'];
	var $porta;// = $this->ini['conexao']['porta']; 	

function CONEXAOVENDAS(){
	$this->Conecta();
}
function Conecta(){
	try {
		...
		$this->link = mysqli_connect($this->url.':'.$this->porta,$this->login,$this->senha, $this->base_vendas);
