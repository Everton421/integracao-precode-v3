...
class CONEXAOEVENTOS {
    ...
    public function Conecta(): void {
        try {
            ...
            $this->base_eventos = $this->ini['conexao']['banco_eventos'];
            $this->porta = $this->ini['conexao']['porta'];
            $this->link = new mysqli($this->host . ':' . $this->porta, $this->login, $this->senha, $this->base_eventos);
