...
include_once(__DIR__.'/utils/enviar-foto.php'); // Inclua o arquivo com a classe EnviarFotos
...
if ($codigoProduto == '' || $codigoProduto == 0) {
    ...
    if ((mysqli_num_rows($produtoPrecode)) == 0) {
     //   echo 'Buscando o produto para ser enviado <br>';
        ...
        $fotos=[];        
        try {
            $fotos = $enviarFotos->enviarFotos($codigoProduto ); // Substitua 123 pelo código apropriado
             //   print_r( $fotos );
        } catch (Exception $e) {
